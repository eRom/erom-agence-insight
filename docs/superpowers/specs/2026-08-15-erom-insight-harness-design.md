...
Écriture dans `~/.claude/erom-plugins/insights/<owner>-<repo>-<YYYY-MM-DD>.md`. En mode `local` sans remote, `local-<nom-du-dossier>-<date>.md`. Collision le même jour : suffixe `-2`.
